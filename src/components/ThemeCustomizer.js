      ...
      <React.Fragment>
        <div className="mt-2 p-2">
          <div className="alert alert-primary" role="alert">
            <strong>{t('setting.titleContent')}</strong>
          </div>
        </div>

        <h5 className="pl-3 font-size-15">{t('setting.layout')}</h5>
          ...
          <div className="pt-2">
            ...
            <div className="custom-control custom-switch mb-1">
              ...
              <label className="custom-control-label" htmlFor="horizontal-check">
                {t('setting.horizontal')}
              </label>
            </div>
          </div>
        </div>

        <h5 className="pl-3 pt-3 border-top font-size-15"> {t('setting.width')}</h5>
        ...
        <hr className="mb-0" />
        <h5 className="pl-3 pt-3 font-size-15"> {t('setting.leftSidebar')}</h5>
...
const I18nThemeCustomizer = withTranslation()(ThemeCustomizer);
